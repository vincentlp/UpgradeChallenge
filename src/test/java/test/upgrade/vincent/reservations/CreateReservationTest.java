...
public class CreateReservationTest {
    ...
    public void when_date_not_available_return_error() {
        CreateReservationDto createDto = UtilsTest.buildCreateDto(1L, 3L);
        Reservation reservation = (Reservation) this.reservationController.createReservation(createDto).getBody();
        ...
        this.reservationController.cancelReservation(new CancelReservationDto(reservation.getId()));
